...
# Дублювання коду для розрахунку середнього часу
...
# Багатопотокова версія з дублюванням коду
...
# Багато дублювання в обчисленнях
def calculate_times():
    total_time_meteofor = 0
    total_time_meta = 0
    total_time_sinoptik = 0
...
# Повторювана і не потрібна функція
def execute():
    calculate_times()
